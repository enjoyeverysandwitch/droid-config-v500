# DisplayName: Jolla v500/@ARCH@ (release) 1
...
repo --name=adaptation0-v500-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-lge-v500/@ARCH@/
...
%packages
@Jolla Configuration v500
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/v500
